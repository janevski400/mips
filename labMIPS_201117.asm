...
.text
	...
	loop: 	beq $t0,$s1,end				#proverka dali $t0 == $s1, dokolku se ednakvi skoka do end, vo sprotivno izvrshuva nareden red		
		...
		la $a0,($t6)				#zapishuvanje na adresata na rezultatot od mnozhenjeto na site neparni broevi vo $a0 koja kje bide iskoristena od syscall
	...
	proizvodNeparni:
		...
		end2:
		sw $t6, ($s0)				#zachuvaj go rezultatot od mnozhenjeto na site neparni broevi vo memoriska lokacija $s0
